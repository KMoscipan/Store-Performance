...
The data for this project was sourced from the **Contoso Retail Demo Database**. Below is the schema diagram showing the key tables and relationships used in this project:
